        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item mx-0 mx-lg-1">
                    <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#contact">Hire a coder</a>
                </li>
            </ul>
        </div>
    </div>
...
<header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
        ...
        <!-- Masthead Heading -->
        <h1 class="masthead-heading text-uppercase mb-0">Freelancer List</h1>
        ...
        <!-- Masthead Subheading -->
        <p class="masthead-subheading font-weight-light mb-0">Daftar developer yang ada di Tasikmalaya</p>
...
<section class="copyright py-4 text-center text-white">
    <div class="container">
        <small>Copyright &copy; Freelancerlist.xyz </small>
    </div>
</section>
...
<script>
    var publicSpreadsheetUrl = 'https://docs.google.com/spreadsheets/d/1wEiafPoyLR07Nxb_fgsRrqefk_ats5rV7bthX8S2H-8/pubhtml';
    ...
    function showInfo(data, tabletop) {
        ...
        $.each(data, function (r) {
            ...
            $("#result").append("<tr><td>" + data[r].name + "</td><td>" + data[r].email + "</td><td>" + data[r].occupation + "</td></tr>  ");
        });
        console.log(data);
    }
